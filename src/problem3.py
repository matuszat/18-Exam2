...
Authors: David Mutchler, Dave Fisher, Matt Boutell, their colleagues,
         and Austin Matuszewski  October 2018.
...
# breakpoint program is good up so far
    ...
    def rain(self, rain_amount):
        ...
        """
        # ---------------------------------------------------------------------
        # DONE?? ERROR SHOULD BE HERE: 3. Implement and test this method.
        # ---------------------------------------------------------------------
    ...
    def merge_cloud(self, another_cloud):
        ...
        """
        # ---------------------------------------------------------------------
        # DONE?? IF TIME GO BACK FIND THE ERROR: 5. Implement and test this method.
        # ---------------------------------------------------------------------
